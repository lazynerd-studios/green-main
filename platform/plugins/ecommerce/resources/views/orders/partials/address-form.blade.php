                        ...
                        @if ($isAvailableAddress)
                            @foreach ($addresses as $address)
                                <option
                                    ...
                                    @endif
                                >
                                    {{ $address->address }}, {{ $address->city_name }}, {{ $address->state_name }}@if (count(EcommerceHelper::getAvailableCountries()) > 1), {{ $address->country_name }} @endif @if (EcommerceHelper::isZipCodeEnabled() && $address->zip_code), {{ $address->zip_code }} @endif</option>
                            @endforeach
                        @endif
                    </select>
