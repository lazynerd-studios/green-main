    ...
    <div class="row">
        <div class="col-lg-8 mb-40">
            ...
            <div class="d-flex justify-content-between">
                @if (count($products) > 0)
                    <h6 class="text-body">{!! clean(__('There are :total products in your cart', ['total' => '<span class="text-brand">' . count($products) . '</span>'])) !!}</h6>
                @endif
            </div>
        </div>
    </div>
                                            ...
                                            <td class="text-center detail-info" data-title="{{ __('Stock') }}">
                                                <div class="detail-extralink mr-15">
                                                    <div class="detail-qty border radius m-auto">
                                                        <input type="hidden" name="items[{{ $key }}][values][qty]" value="{{ $cartItem->qty }}">
