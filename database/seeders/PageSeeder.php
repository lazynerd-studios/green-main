...
class PageSeeder extends BaseSeeder
{
    ...
    public function run()
    {
        ...
        foreach ($pages as $item) {
            ...
            $page = Page::create(Arr::except($item,
            ...
            if (isset($item['expanding_product_categories_on_the_homepage'])) {
                MetaBox::saveMetaBoxData($page, 'expanding_product_categories_on_the_homepage',
        ...
        $simpleSlider1 = Html::tag('div',
            '[simple-slider key="home-slider-1" show_newsletter_form="yes"][/simple-slider]');
        $productCategories = Html::tag('div',
